    ...
    return (
        ...
        <div className="main">
            <div className="hero-container">
                <img src="/static/images/conf-bg-min.jpg" alt="wallpaper hero accueil" style={{objectFit:"cover"}} />
                <div className="hero-bg"></div>
            </div>
            <div className="section-title">
                <h2 style={{fontSize:"2.4rem",fontWeight:"400",letterSpacing:"-2px",color:"#fff"}} >Politiques de confidentialité</h2>
            </div>
        </div>

                <div className="container">
                    <div className="sec-text">
                        <span>Cette politique s'applique au site : n-seddi.com</span>
                        <span>Date de dernière mise à jour : 19 octobre 2020</span>
                    </div>

                    <div className="textil">
                                <p>Le respect de votre vie privée est de la plus haute importance pour n-seddi.com, qui est responsable de ce site.</p>
...
Cette politique de confidentialité complète les Conditions générales d'utilisation que vous pouvez consulter à l'adresse ci-après :</p>
                                <a target = "_blank" href='https://n-seddi.com'>https://n-seddi.com</a>
                            </div>
                            ...
                            <div className="textil">
                                <p>Vos renseignements personnels sont également collectés par le biais de l'interactivité pouvant s'établir entre vous et notre site Web. Ces renseignements sont collectés par les moyens suivants :</p>
                                <ul>
                            ...
                            <div className="textil">
                                ...
                                <strong>a) Description des fichiers témoins utilisés par le site</strong>
                                <p>Il s'agit principalement des informations suivantes :
                                ...
                                Suivis de commande
                                Études statistiques
                                En navigant sur le site, des fichiers témoins de tiers peuvent être enregistrés. Il s'agit particulièrement des tiers suivants :
...
Ces sites disposent de politiques de confidentialité propres et de conditions générales d'utilisation possiblement différentes de notre site. Nous vous invitons à consulter les politiques de confidentialité et les conditions générales d'utilisation de ces sites.</p>
                                <strong>b) Opposition à l'utilisation de fichiers témoins par le site</strong>
                                <p>Vous pouvez vous opposer à l'enregistrement de ces fichiers témoins en configurant votre logiciel de navigation.

Dans le cas où vous décidez de désactiver les fichiers témoins, vous pourrez ensuite poursuivre votre navigation sur le site. Toutefois, tout dysfonctionnement du site provoqué par cette manipulation ne peut être considéré comme étant de notre fait.</p>
                            </div>
                            ...
                            <div className="textil">
                                <p>Le responsable du traitement des renseignements personnels conservera dans ses systèmes informatiques du site et dans des conditions raisonnables de sécurité l'ensemble des renseignements personnels collectés pour une durée de : 12 mois au maximum.</p>
                            </div>
                            ...
                            <div className="textil">
                                ...
                                <p>Le responsable du traitement des renseignements personnels est : n-seddi.com. Il peut être contacté de la manière suivante :</p>
                                <a target = "_blank" href="https://n-seddi.com">https://n-seddi.com</a>
...
Dans le cas où l'intégrité, la confidentialité ou la sécurité de vos renseignements personnels est compromise, le responsable du traitement s'engage à vous en informer par tout moyen.</p>
                            </div>
...
Afin de formuler une opposition au traitement de vos renseignements personnels ou demander le retrait de vos renseignements personnels, vous devez suivre la procédure suivante :</p>
                            ...
                            <div className="textil">
                                ...
                                <p>Nous nous engageons à maintenir un haut degré de confidentialité en intégrant les dernières innovations technologiques permettant d'assurer la confidentialité de vos transactions. Toutefois, comme aucun mécanisme n'offre une sécurité maximale, une part de risque est toujours présente lorsqu'on utilise Internet pour transmettre des informations personnelles.</p>
                            </div>
                            <h3>11. ENFANTS</h3>
                            <div className="textil">
                                <p>
                                    Notre site Web contient des sections destinées aux enfants. La collecte de leurs renseignements personnels se fait avec le consentement des parents ou du représentant de l'enfant. Nous demandons le consentement de ces derniers par le biais :</p>
                                <ul>
                            ...
                            <div className="textil">
                                ...
                                <a target = "_blank" href="https://n-seddi.com/politiques-de-confidentialite">https://n-seddi.com/politiques-de-confidentialite</a>
...
Toutefois, en cas de modification substantielle de cette politique, vous en serez informé(e) de la manière suivante.</p>
                            </div>      
                </div>        
